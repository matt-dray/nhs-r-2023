...
title-slide-attributes:
  ...
  data-notes: |
    ...
    * The title of my talk is an off-the-mark pun on 'slap bass', the musical technique, but also an off-the-mark reference to how 'young people these days' say 'cool'. The fact I felt I had to explain this to you shows how truly cool I am.
...
::: {.column width='50%'}
![](images/ross.jpg){fig-alt="Ross Ihaka wearing sweet New Balance trainers." width="80%" fig-align="center"}
:::

::: {.column width='50%'}
![](images/robert.png){fig-alt="Robert Gentleman holds a power pose." width="80%" fig-align="center"}
:::
